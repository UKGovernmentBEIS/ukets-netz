...
public class OperatorAccountSearchServiceTest {

    @InjectMocks
    private OperatorAccountSearchService cut;
    ...
    void getUserAccountsBySearchCriteria() {
        ...
        when(accountSearchService.searchAccounts(new ArrayList<>(appUser.getAccounts()), searchCriteria))
        ...
        // verify
        verify(accountSearchService, times(1)).searchAccounts(new ArrayList<>(appUser.getAccounts()), searchCriteria);
