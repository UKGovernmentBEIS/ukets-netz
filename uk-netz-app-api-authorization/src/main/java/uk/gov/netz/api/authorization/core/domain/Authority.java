...
@NamedQuery(
        ...
        query = "select new uk.gov.netz.api.authorization.regulator.domain.RegulatorUserAssignedSubResource("
...
@NamedQuery(
        ...
        query = "select new uk.gov.netz.api.authorization.verifier.domain.VerifierUserAssignedSubResource("
...
@NamedQuery(
        ...
        query = "select new uk.gov.netz.api.authorization.operator.domain.OperatorUserAssignedSubResource("
...
@NamedQuery(
        ...
        query = "select au.userId as userId, au.status as status "
                ...
                + "and au.competentAuthority =: competentAuthority")
@NamedQuery(
        name = Authority.NAMED_QUERY_EXISTS_AUTHORITY_NOT_FOR_CA_OR_NULL,
        query = "select count(au.id) > 0 "
                + "from Authority au "
                + "where au.userId = :userId "
                + "and (au.competentAuthority is null or au.competentAuthority != :competentAuthority) ")
@NamedQuery(
        name = Authority.NAMED_QUERY_EXISTS_AUTHORITY_NOT_FOR_VB_OR_NULL,
        query = "select count(au.id) > 0 "
                + "from Authority au "
                + "where au.userId = :userId "
                + "and (au.verificationBodyId is null or au.verificationBodyId != :verificationBodyId) ")
public class Authority implements GrantedAuthority {
    ...
    public static final String NAMED_QUERY_EXISTS_AUTHORITY_NOT_FOR_CA_OR_NULL = "Authority.existsAuthorityNotForCAOrNull";
    public static final String NAMED_QUERY_EXISTS_AUTHORITY_NOT_FOR_VB_OR_NULL = "Authority.existsAuthorityNotForVBOrNull";
