...
public interface AuthorityRepository extends JpaRepository<Authority, Long>, AuthorityCustomRepository {
    ...
    @Transactional(readOnly = true)
    List<Authority> findAllByUserIdInAndAccountId(Set<String> userIds, Long accountId);
    ...
    @Transactional(readOnly = true)
    @Query(name =  Authority.NAMED_QUERY_EXISTS_AUTHORITY_NOT_FOR_CA_OR_NULL)
	boolean existsByUserIdAndCompetentAuthorityNotForCAOrNull(String userId,
    ...
    @Transactional(readOnly = true)
    @Query(name =  Authority.NAMED_QUERY_EXISTS_AUTHORITY_NOT_FOR_VB_OR_NULL)
	boolean existsByUserIdAndVerificationBodyIdNotForVBOrNull(String userId, Long verificationBodyId);
    
    @Transactional(readOnly = true)
	boolean existsByUserIdAndAccountIdIsNull(String userId);
