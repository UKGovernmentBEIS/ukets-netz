package uk.gov.netz.api.authorization.core.repository.impl;
...
import uk.gov.netz.api.authorization.core.repository.AuthorityCustomRepository;
import uk.gov.netz.api.authorization.operator.domain.OperatorUserAssignedSubResource;
import uk.gov.netz.api.authorization.regulator.domain.RegulatorUserAssignedSubResource;
import uk.gov.netz.api.authorization.verifier.domain.VerifierUserAssignedSubResource;
...
public class AuthorityCustomRepositoryImpl implements AuthorityCustomRepository {
    ...
    public Map<Long, Set<String>> findResourceSubTypesVerifierUserHasScope(String userId, String resourceType, String scope) {
        return em.createNamedQuery(Authority.NAMED_QUERY_FIND_VERIFIER_USER_ASSIGNED_RESOURCE_SUB_TYPES, VerifierUserAssignedSubResource.class)
                ...
                Collectors.mapping(VerifierUserAssignedSubResource::getResourceSubType,
