...
class RegulatorAuthorityServiceTest {
    ...
    @Test
   	void existsNonPendingAuthorityForCA_Exists() {
   		...
   		when(authorityRepository.findByUserIdAndCompetentAuthority(userId, competentAuthority)).thenReturn(Optional.of(authority));
   		
   		boolean result = service.existsNonPendingAuthorityForCA(userId, competentAuthority);
   	...
   	@Test
   	void existsNonPendingAuthorityForCA_not_Exists() {
   		String userId = "userId";
   		CompetentAuthorityEnum competentAuthority = CompetentAuthorityEnum.ENGLAND;
   		Authority authority = Authority.builder()
   				.competentAuthority(competentAuthority)
   	...
   	@Test
   	void existsNonPendingAuthorityForCA_not_Exists_no_authority() {
   		String userId = "userId";
   		CompetentAuthorityEnum competentAuthority = CompetentAuthorityEnum.ENGLAND;
   		
   		when(authorityRepository.findByUserIdAndCompetentAuthority(userId, competentAuthority)).thenReturn(Optional.empty());
   	...
   	@Test
   	void existsAuthorityNotForCA() {
   		String userId = "userId";
   		CompetentAuthorityEnum competentAuthority = CompetentAuthorityEnum.ENGLAND;
   		
   		service.existsAuthorityNotForCA(userId, competentAuthority);
   		
   		verify(authorityRepository, times(1)).existsByUserIdAndCompetentAuthorityNotForCAOrNull(userId, competentAuthority);
   	}
