...
class MiReportUserDefinedAccessRuleHandlerTest {

    @InjectMocks
    private MiReportUserDefinedAccessRuleHandler handler;

    @Mock
    private MiReportUserDefinedAuthorityInfoProvider miReportUserDefinedAuthorityInfoProvider;
    ...
    void evaluateRules() {
        ...
        when(miReportUserDefinedAuthorityInfoProvider.getMiReportCaById(miReportId)).thenReturn(competentAuthority);

        handler.evaluateRules(rules, appUser, String.valueOf(miReportId));

        verify(miReportUserDefinedAuthorityInfoProvider).getMiReportCaById(miReportId);
        verify(appAuthorizationService).authorize(appUser, authorizationCriteria);
        verifyNoMoreInteractions(miReportUserDefinedAuthorityInfoProvider, appAuthorizationService);
    }
    ...
    void evaluateRules_resource_forbidden() {
        ...
        when(miReportUserDefinedAuthorityInfoProvider.getMiReportCaById(miReportId)).thenReturn(resourceCompetentAuthority);
