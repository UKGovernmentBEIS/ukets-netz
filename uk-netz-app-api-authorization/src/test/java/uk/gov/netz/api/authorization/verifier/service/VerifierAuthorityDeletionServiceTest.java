...
class VerifierAuthorityDeletionServiceTest {
    ...
    void deleteVerifierAuthority_regulator_auth_user() {
        final String userId = "userId";
        final AppUser authUser = AppUser.builder().userId("authUserId").roleType(RoleTypeConstants.REGULATOR).build();
    ...
    void deleteVerifierAuthority_auth_user_role_not_supported() {
        final String userId = "userId";
        final AppUser authUser = AppUser.builder().userId("authUserId").roleType(RoleTypeConstants.OPERATOR).build();
