...
public class ArchUnitTest {
    ...
    static final String COMPANIESHOUSE_PACKAGE = BASE_PACKAGE + ".companieshouse..";
    static final String COMMON_PACKAGE = BASE_PACKAGE + ".common..";

    static final List<String> ALL_PACKAGES = List.of(
            COMMON_PACKAGE,
            COMPANIESHOUSE_PACKAGE
    );

    @ArchTest
    public static final ArchRule companieshousePackageChecks =
            noClasses().that()
                    .resideInAPackage(COMPANIESHOUSE_PACKAGE)
