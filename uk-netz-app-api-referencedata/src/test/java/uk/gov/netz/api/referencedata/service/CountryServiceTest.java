...
class CountryServiceTest {
	...
	@Test
	void getUKReferenceData() {
		when(countryRepository.findAllByCodeIn(Set.of("GB-ENG", "GB-NIR", "GB-SCT", "GB-WLS")))
				.thenReturn(buildCountries("GB-ENG", "GB-NIR"));

		List<Country> countries = countryService.getUKReferenceData();

		assertThat(countries)
				.hasSize(2)
				.extracting(Country::getCode)
				.containsOnly("GB-ENG", "GB-NIR");
		verify(countryRepository, times(1))
				.findAllByCodeIn(Set.of("GB-ENG", "GB-NIR", "GB-SCT", "GB-WLS"));
	}
