...
public class ItemByRequestRegulatorRepository {
    ...
    public ItemPage findItemsByRequestId(Map<CompetentAuthorityEnum, Set<String>> scopedCARequestTaskTypes, String requestId) {
        ...
        final BooleanExpression caRequestTaskScopeWhereClause = ItemRepoUtils.constructCARequestTaskScopeWhereClause(
                scopedCARequestTaskTypes, requestTask, requestResource);
