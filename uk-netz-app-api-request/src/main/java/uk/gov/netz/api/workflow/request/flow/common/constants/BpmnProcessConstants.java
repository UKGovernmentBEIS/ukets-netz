...
public class BpmnProcessConstants {
    ...
    // application review
    public static final String APPLICATION_REVIEW_EXPIRATION_DATE = RequestExpirationKeys.APPLICATION_REVIEW + _EXPIRATION_DATE;
    ...
    public static final String RFI_EXPIRATION_DATE = RequestExpirationKeys.RFI + _EXPIRATION_DATE;
    public static final String RFI_FIRST_REMINDER_DATE = RequestExpirationKeys.RFI + _FIRST_REMINDER_DATE;
    public static final String RFI_SECOND_REMINDER_DATE = RequestExpirationKeys.RFI + _SECOND_REMINDER_DATE;
    ...
    public static final String RDE_EXPIRATION_DATE = RequestExpirationKeys.RDE + _EXPIRATION_DATE;
    public static final String RDE_FIRST_REMINDER_DATE = RequestExpirationKeys.RDE + _FIRST_REMINDER_DATE;
    public static final String RDE_SECOND_REMINDER_DATE = RequestExpirationKeys.RDE + _SECOND_REMINDER_DATE;
    ...
    public static final String PAYMENT_EXPIRATION_DATE = RequestExpirationKeys.PAYMENT + _EXPIRATION_DATE;
