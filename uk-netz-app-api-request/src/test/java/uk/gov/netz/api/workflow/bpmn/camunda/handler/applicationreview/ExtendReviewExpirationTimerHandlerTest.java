...
class ExtendReviewExpirationTimerHandlerTest {
    ...
    void execute() {
        ...
        when(extendReviewExpirationTimerService.extendTimer(requestId, RequestExpirationKeys.APPLICATION_REVIEW))
        ...
        verify(requestExpirationVarsBuilder, times(1)).buildExpirationVars(RequestExpirationKeys.APPLICATION_REVIEW, dueDate);
