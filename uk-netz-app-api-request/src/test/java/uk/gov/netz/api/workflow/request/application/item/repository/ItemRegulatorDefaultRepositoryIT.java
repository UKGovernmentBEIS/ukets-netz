...
@Testcontainers
@DataJpaTest
@Import({ObjectMapper.class, ItemRegulatorDefaultRepository.class})
class ItemRegulatorDefaultRepositoryIT extends RequestAbstractTest {

    @Autowired
    private ItemRegulatorDefaultRepository cut;
    ...
    void findItems_assigned_to_me() {
        ...
        ItemPage itemPage =
                cut.findItems(user, ItemAssignmentType.ME, scopedRequestTaskTypes,
    ...
    void findItems_assigned_to_others() {
        ...
        ItemPage itemPage =
                cut.findItems(user, ItemAssignmentType.OTHERS, scopedRequestTaskTypes,
                    PagingRequest.builder().pageNumber(0).pageSize(10).build(), getItemSearchCriteria(ItemOrderBy.NEWEST_FIRST, null, null));
    ...
    void findItems_unassigned() {
        ...
        ItemPage itemPage =
                cut.findItems(user, ItemAssignmentType.UNASSIGNED, scopedRequestTaskTypes,
                    PagingRequest.builder().pageNumber(0).pageSize(10).build(), getItemSearchCriteria(ItemOrderBy.NEWEST_FIRST, null, null));
    ...
    void findItems_filterByAccountName(String searchTerm) {
        ...
        Long accountId3 = -3L;
        TestAccount account3 = createAccount(accountId3, "other2", CompetentAuthorityEnum.SCOTLAND, "businessId3");
        String user = "user";
        ...
        Request request3 = createRequest(account3.getId(), CompetentAuthorityEnum.SCOTLAND, 3L, requestType1, "procInstId3", statusInProgress, LocalDateTime.now());
    ...
    void findItems_filterByAccountBusinessId() {
        ...
        Long accountId3 = -3L;
        TestAccount account3 = createAccount(accountId3, "account", CompetentAuthorityEnum.SCOTLAND, "B3");
        String user = "user";
