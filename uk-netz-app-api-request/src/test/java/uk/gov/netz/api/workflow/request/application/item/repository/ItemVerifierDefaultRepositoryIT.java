...
@Testcontainers
@DataJpaTest
@Import({ObjectMapper.class, ItemVerifierDefaultRepository.class})
class ItemVerifierDefaultRepositoryIT extends RequestAbstractTest {

    @Autowired
    private ItemVerifierDefaultRepository cut;
    ...
    void findItems_assigned_to_others() {
        ...
        createRequestTask(null, request1, requestTaskType2, "t7", request1.getCreationDate());
    ...
    void findItems_unassigned() {
        ...
        Request request3 = createRequest(account1_2, CompetentAuthorityEnum.ENGLAND, 3L, requestType1, "procInstId2", statusInProgress, LocalDateTime.now());
        createRequestTask("anotherUser", request3, requestTaskType2, "t4", request3.getCreationDate());

        Request request6 = createRequest(2L, CompetentAuthorityEnum.ENGLAND, 6L, requestType1, "procInstId3", statusInProgress, LocalDateTime.now());
        createRequestTask(user, request6, requestTaskType1, "t7", request6.getCreationDate());

        Request request7 = createRequest(2L, CompetentAuthorityEnum.ENGLAND, 7L, requestType1, "procInstId4", statusInProgress, LocalDateTime.now());
        createRequestTask(user, request7, requestTaskType2, "t8", request7.getCreationDate());

        Request request8 = createRequest(2L, CompetentAuthorityEnum.ENGLAND, 8L, requestType1, "procInstId5", statusInProgress, LocalDateTime.now());
        createRequestTask(user, request8, requestTaskType1, "t9", request8.getCreationDate());
