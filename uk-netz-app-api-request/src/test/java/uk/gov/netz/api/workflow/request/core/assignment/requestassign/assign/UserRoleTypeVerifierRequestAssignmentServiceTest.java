...
class UserRoleTypeVerifierRequestAssignmentServiceTest {

	@InjectMocks
    private UserRoleTypeVerifierRequestAssignmentService cut;
	...
	void assign() {
		...
		assertThat(payload.getVerifierAssignee()).isEqualTo("userId");
	}
}
