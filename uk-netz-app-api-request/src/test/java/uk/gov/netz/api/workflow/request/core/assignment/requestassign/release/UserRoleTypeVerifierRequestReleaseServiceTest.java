...
class UserRoleTypeVerifierRequestReleaseServiceTest {

	@InjectMocks
    private UserRoleTypeVerifierRequestReleaseService cut;
	...
	void release() {
		...
		assertThat(payload.getVerifierAssignee()).isNull();
	}
