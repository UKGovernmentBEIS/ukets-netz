...
class RequestTaskCreateServiceTest {
    ...
    void create_assign_to_user_provided() {
        final RequestTaskType type = RequestTaskType.builder().code("DUMMY_REQUEST_TYPE_APPLICATION_REVIEW").build();
        ...
        when(initializeRequestTaskHandler.getRequestTaskTypes()).thenReturn(Set.of(type.getCode()));
    ...
    void create_assign_to_default() {
        final RequestTaskType type = RequestTaskType.builder().code("DUMMY_REQUEST_TYPE_APPLICATION_REVIEW").build();
        Request request = createRequest();
        RequestTask requestTask = createRequestTask(request, PROCESS_TASK_ID, type);
    ...
    private RequestTask createRequestTask(Request request, String processTaskId, RequestTaskType requestTaskTypeCode) {
        return RequestTask.builder()
                .request(request)
                .processTaskId(processTaskId)
                .type(requestTaskTypeCode)
                .build();
    }
