...
class RfiSendEventServiceTest {
    ...
    void send() {
        ...
        when(requestExpirationVarsBuilder.buildExpirationVars(RequestExpirationKeys.RFI, deadlineDate))
        ...
        // Verify
        verify(requestExpirationVarsBuilder, times(1)).buildExpirationVars(RequestExpirationKeys.RFI, deadlineDate);
