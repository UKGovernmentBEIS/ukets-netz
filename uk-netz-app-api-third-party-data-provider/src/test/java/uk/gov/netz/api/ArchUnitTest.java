...
public class ArchUnitTest {
    ...
    static final String THIRD_PARTY_DATA_PROVIDER_PACKAGE = BASE_PACKAGE + ".thirdpartydataprovider..";

    static final List<String> ALL_PACKAGES = List.of(
            COMMON_PACKAGE,
            AUTHORIZATION_PACKAGE,
            THIRD_PARTY_DATA_PROVIDER_PACKAGE
    );

    @ArchTest
    public static final ArchRule thirdPartyPackageChecks =
            noClasses().that()
                    .resideInAPackage(THIRD_PARTY_DATA_PROVIDER_PACKAGE)
