...
class UserFileTokenServiceTest {
    ...
    void resolveGetFileAttachmentUuid() {
        ...
        when(jwtTokenService.resolveTokenActionClaim(getFileAttachmentToken, JwtTokenAction.GET_FILE))
        ...
        verify(jwtTokenService, times(1)).resolveTokenActionClaim(getFileAttachmentToken, JwtTokenAction.GET_FILE);
    }
