...
class UserResetPasswordServiceTest {
    ...
    void sendVerificationEmail() {
        ...
        assertThat(notificationInfo.getTemplateName()).isEqualTo(NotificationTemplateName.RESET_PASSWORD_REQUEST);
        assertThat(notificationInfo.getUserEmail()).isEqualTo(EMAIL);
        assertThat(notificationInfo.getLinkParamName()).isEqualTo(NotificationTemplateConstants.RESET_PASSWORD_LINK);
        ...
        .isEqualTo(Map.of(
                ...
                NotificationTemplateConstants.EXPIRATION_MINUTES, 20L));
