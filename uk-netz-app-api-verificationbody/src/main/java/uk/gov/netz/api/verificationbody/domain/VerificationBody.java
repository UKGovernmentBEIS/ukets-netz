...
@NamedQuery(
        ...
        query = "select new uk.gov.netz.api.verificationbody.domain.dto.VerificationBodyNameInfoDTO(vb.id, vb.name) "
...
public class VerificationBody {
    ...
    public void removeEmissionTradingSchemes(Set<String> schemes) {
		emissionTradingSchemes.removeAll(schemes);
    }

    public void addEmissionTradingSchemes(Set<String> schemes) {
